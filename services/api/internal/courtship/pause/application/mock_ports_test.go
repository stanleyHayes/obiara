...
import (
	...
	domain "github.com/stanleyHayes/obiara/services/api/internal/courtship/pause/domain"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 domain.Stone) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Find(arg0 context.Context, arg1 string) (domain.Stone, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Find", arg0, arg1)
	ret0, _ := ret[0].(domain.Stone)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Save(arg0 context.Context, arg1 domain.Stone, arg2 uint64, arg3 string) error {
	m.ctrl.T.Helper()
