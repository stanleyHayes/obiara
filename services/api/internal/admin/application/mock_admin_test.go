...
//
//	mockgen -source services/api/internal/admin/application/admin.go -destination services/api/internal/admin/application/mock_admin_test.go -package application PrincipalRepository,ChallengeRepository,SessionRepository,AccessAudit,CodeSender
//
...
func (m *MockCodeSender) SendMfaCode(ctx context.Context, email, code string) error {
	m.ctrl.T.Helper()
...
func (mr *MockCodeSenderMockRecorder) SendMfaCode(ctx, email, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMfaCode", reflect.TypeOf((*MockCodeSender)(nil).SendMfaCode), ctx, email, code)
}
