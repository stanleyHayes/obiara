...
| Abusua Gate         | `/fie/abusua-gate`                              | `/fie/abusua-gate`              |               2 | saved consent draft only; invite issuance requires network | validate pair ownership, both-member consent and reviewer-link expiry                |
