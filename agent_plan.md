...
| S8-032 | E13-S01 client notification preferences, quiet hours and cap transparency | 5 | `codex-root` | IN PROGRESS | guarded web/Expo notification settings with shared pure reducer; no dispatcher, provider, preference persistence or delivery mutation | claimed 2026-07-26 after S8-029 companion client closure | web/mobile preference, safety-override, quiet-hours, cap and rendered interaction proofs pending | Per-category/channel choice, local quiet-hours window, six-per-day explanation and immutable safety/OTP service override disclosure | No engagement bait, pressure/jealousy copy, disabling critical safety/OTP, fake urgency, popularity/view signals or claim that client settings alone enforce delivery |
