...
| S2-008 | E01-S09a Web Hold, Sow, Stone and Gather prototypes | 2 | `codex-root` | IN PROGRESS | `apps/web/app/design-lab/`, web gesture primitives | claimed 2026-07-26 after S2-007 | component interactions plus 390px/desktop browser QA | 8 SP; keyboard, pointer, screen-reader and reduced-motion equivalents required; rebase before every commit |
| S2-009 | E01-S09b Expo Hold, Sow, Stone and Gather prototypes | 2 | `/root/mobile_gestures` | IN PROGRESS | `apps/mobile/app/design-lab/`, mobile gesture primitives | claimed 2026-07-26 after S2-007 | RN interactions, Expo export and Android smoke | 8 SP; no gesture-only path; one-handed 48dp controls; rebase before every commit |
