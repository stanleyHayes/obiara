...
| S8-072 | E17-S10 release notes, UAT, rollback and hypercare evidence bundle | 5 | `codex-root` | IN PROGRESS | `deploy/release/` evidence schema, operator checklist and deterministic validation; no release publication, deployment, store submission, notification or production mutation | claimed 2026-07-27 after E17-S01–S09 controls and E18 hypercare desk; current release-evidence, mobile, SLO, DR, security and launch gates reviewed | immutable candidate/notes/UAT/rollback/hypercare ownership, production-gate, privacy and incomplete-evidence negative proofs pending | A release bundle must bind the exact qualified commit and artifacts to bounded notes, consented UAT results, rehearsed rollback, named hypercare ownership and all current blocking evidence; incomplete or stale evidence fails closed | No raw feedback/member/contact data, vague latest version, automatic deploy/submit/notify, self-approval, hidden blocker, untested rollback, false production approval, incident closure or external mutation |
