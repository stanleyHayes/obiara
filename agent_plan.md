...
| S8-031 | E13-S09 banned engagement-pattern test suite | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/notifications/engagementpolicy/` pure policy/test boundary; no dispatcher or template persistence ownership | claimed 2026-07-26 after S8-023 women-review lane release | reviewed catalog, exact/normalized/property/fuzz and architecture proofs pending; Mongo/Testcontainers applicability must be documented | Deny view/jealousy/fake-urgency/popularity/romantic-pressure patterns across notification title/body/template metadata; fail closed on unknown locale/category | No content generation, delivery, member inference, quiet-hour/cap bypass, mutable unversioned list or hidden engagement score |
