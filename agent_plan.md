...
| S0-010 | Expo/Android floor, media and 3G feasibility spike | 0 | `codex-root` | IN PROGRESS | `apps/mobile/`, `internal/architecture/mobile-feasibility.md` | claimed 2026-07-26 after S0-005 completion | Android reference build/device evidence pending | Codex owns mobile UI implementation and rendered review |
...
| S0-012 | Initial threat model, data classification and DPIA inputs | 0 | `/root/backend_security` | IN PROGRESS | `internal/architecture/threat-model-v0.md`, `internal/architecture/data-classification.md`, `internal/architecture/dpia-inputs.md` | claimed 2026-07-26; dependency S0-003 complete | security/privacy review pending | — |
