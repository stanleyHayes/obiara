...
| S8-020 | E12-S04 Action ladder and propagated account/device controls | 10 | `/root/backend_safety` | IN PROGRESS | `internal/safety/` (actions), identity status transitions, `services/worker/internal/jobs/safety/` | claimed 2026-07-26; continues S7-026 queues | ladder validation + propagation integration pending | — |
