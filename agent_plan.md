...
| S7-021 | E10-S07 Ampe realtime round domain | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/games/ampe/` server-authoritative round/realtime state; no client UI | reassigned 2026-07-26 after prior agent released clean before inspection/edit | GoMock, simultaneous-lock/reveal/idempotency/property/race and persistence applicability proofs pending | Opaque two-player room, bounded choices and server sequence; choices hidden until both lock; disconnect cannot forfeit or expose choice; no camera/body data, public score, matching/rating/trust coupling |
| S7-022 | E10-S08 client tournaments, private ladder and anti-cheat transparency | 5 | `codex-root` | IN PROGRESS | guarded web/Expo Games hall with joined tournament, bounded ladder context and fair-play review states | claimed 2026-07-26 after E10 game clients; no backend file overlap | model/UI tests; web/mobile typecheck/lint/build; rendered accessibility/interaction/overflow QA pending | Opt-in tournament only; conduct/fair-play review is explainable and appealable; no global popularity, discovery, matching advantage, public accusation, dark urgency or pay-to-rank |
| S7-023 | E10-S08 tournament, ladder and anti-cheat domain | 8 | unassigned | READY | isolated `services/api/internal/games/competition/` domain/application/persistence; no client UI | ready after E10 game/rating/conduct foundations | GoMock, bracket/ladder/fair-play/appeal property/race and live MongoDB Testcontainers proofs pending | Opt-in bounded cohorts; game results only; conduct signals remain separate; anti-cheat creates review evidence not automatic accusation; no matching/discovery/popularity/pay-to-rank export |
