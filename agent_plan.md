...
| S8-027 | E12-S11 admin fraud-victim evidence export path | 5 | `codex-root` | IN PROGRESS | extend `apps/admin/app/safety/` with pure export reducer/MUI dialog; no file generation, evidence store or external recipient | claimed 2026-07-26 after S8-013/S15 evidence/action desk | reducer/consent/scope/redaction/expiry tests plus admin typecheck/lint/build and rendered browser proofs pending | Victim-requested bounded export, explicit included-reference checklist, reporter/third-party redaction, purpose/expiry and human confirmation; no accused-party disclosure, raw hidden evidence, automatic sharing, perpetual link, case action or victim-blaming copy |
