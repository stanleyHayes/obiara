...
| S8-075 | Cross-epic backlog traceability closure audit | 3 | `codex-root` | IN PROGRESS | `internal/quality/backlog-closure.md` and existing implementation/test verification only; no product, provider, deployment or external mutation | claimed 2026-07-27 after E17 completion audit found bundled/legacy story identifiers and two real P2 gaps delegated as S8-073/S8-074 | every E01–E18 story ID mapped to a DONE ledger row or active gap; finance/admin/notification/liveness/analytics/security evidence verification pending | Closure report must distinguish implemented-under-another-ID from genuinely absent work, link exact code/tests and leave no TODO/IN PROGRESS row before backlog completion | No papering over missing code, false production readiness, unverified status, duplicate implementation, destructive cleanup, provider call or external mutation |
| S8-073 | E14-S09 P2 diaspora payment isolation | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/commerce/diaspora/` domain/application/persistence boundary with provider and exact ledger-proof ports; no MoMo, provider network, client UI or member-transfer ownership | claimed 2026-07-27 after confirming only Ghana MoMo/GHS collection exists; PRD M1-05, pricing Doc 03 diaspora GBP/USD/EUR, architecture PCI enclave/no-member-transfer law and cross-border compliance reviewed | currency/minor-unit/price-version/provider-confirmation/ledger-isolation/idempotency/privacy/property/race/fuzz and live MongoDB Testcontainers concurrency/CAS proofs pending | Immutable diaspora checkout intent accepts only GBP/USD/EUR catalog quotes, uses an opaque isolated-provider request/confirmation and can request only a balanced platform-commerce ledger proof after exact settlement; no GHS/MoMo or member-to-member primitive is exposed | No provider/network call, real fund, card/PayPal credential, raw member/contact data, FX conversion, GHS/MoMo mutation, member transfer, unconfirmed entitlement, duplicate posting, mutable quote, cross-purpose export or automatic refund/payout |
| S8-074 | E13-S07 P2 Gate links and USSD companion | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/companions/p2gate/` domain/application/persistence boundary for consent-bound reviewer-link proposals and minimal USSD session views; no gateway/provider/network integration or source aggregate mutation | claimed 2026-07-27 after PRD M6/M12, SRS FR-701, UX S-50–S-53, notification routing and MoMo USSD-push audit confirmed no P2 companion implementation | generated Uber GoMock consent/current-source orchestration, property/race/vet/fuzz and live MongoDB 8.0.13 Testcontainers idempotency/concurrency/expiry/privacy proofs pending | Gate link proposals require exact current bilateral pack consent, named opaque reviewer, OTP-gated single-purpose 30-day expiry and no-forward watermark contract; authenticated USSD exposes only bounded pod count, drum-waiting indicator, fire schedule and approved help refs | No raw phone/contact/content persistence, global browse, courtship conversation, Gate pack delivery, automatic invite/SMS/approach, balance/payment flow, provider call, refusal signal, consent bypass, forwarding, expiry extension or external mutation |
