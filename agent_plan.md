...
| S7-014 | E13-S02 Dawn, Monday, fire and Sunday rituals | 10 | `/root/backend_notifications` | IN PROGRESS | `services/api/internal/notifications/ritual/`, `services/worker/internal/jobs/ritual/` | claimed 2026-07-26 after dropping raced S7-013 claim (§18.5) | schedule unit tests + dispatch integration pending | — |
...
| S7-016 | E10 client Ɛbɛ duel experience | 5 | `codex-root` | IN PROGRESS | guarded web/Expo private duel route using reviewed fixture contract, accessible answer/reveal states | claimed 2026-07-26 alongside S7-015 with no backend file overlap | model/UI tests; web/mobile typecheck/lint/build; rendered accessibility/interaction/overflow QA pending | Calm private turn-taking with source/language context and deliberate reveal; no public score, shame, speed pressure, matching advantage, cultural-authority claim or unreviewed user prompt |
