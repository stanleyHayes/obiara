...
| S2-013 | E03-S06 Tier/account state machines and transition audit | 2 | `/root/backend_identity` | IN PROGRESS | `services/api/internal/identity/` | claimed 2026-07-26; dependency S2-011 complete | state-machine unit + integration tests pending | — |
