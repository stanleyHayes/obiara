...
| S1-004 | E02-S06 Idempotency, optimistic concurrency, outbox and inbox | 1 | `/root/backend_kernel` | IN PROGRESS | `services/api/internal/platform/`, `services/worker/` | claimed 2026-07-26; dependency S1-002 complete | unit + Testcontainers integration pending | — |
