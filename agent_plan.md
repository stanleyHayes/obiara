...
| L1-004 | Admin launch-decision readiness surface | Launch 1 | `codex-root` | IN PROGRESS | `apps/admin/app/launch/`, shared admin presentation primitives only | claimed 2026-07-27 after inventory contract; L1-002 registry structure will be cross-reviewed before closure | Pending model/UI tests, typecheck, lint, build and rendered desktop/mobile QA | Codex owns primary UI implementation; surface must expose exact owner, evidence freshness, dependency and blocker state without a launch button |
