...
| S2-002 | E01-S05 Typed EN/Twi string registry and terminology policy | 2 | `/root/i18n_foundation` | IN PROGRESS | `packages/i18n/` | claimed 2026-07-26 after E01 audit | catalog parity/interpolation/fallback/terminology tests | 5 SP; record Twi community-review state and do not mark unapproved translations production-ready; rebase before every commit |
| S2-003 | E01-S02 Member MUI theme and shared web primitives | 2 | `codex-root` | IN PROGRESS | `packages/ui-web/` | claimed 2026-07-26 after S2-001 | theme, keyboard/focus, target-size and reduced-motion tests; build | 5 SP; stable exported API and Outfit typography; rebase before every commit |
...
| S2-005 | E01-S04 Expo theme and base interaction primitives | 2 | `/root/mobile_ui` | IN PROGRESS | `packages/ui-mobile/`, `apps/mobile/app/_layout.tsx` | claimed 2026-07-26 after S2-001 | React Native tests, Expo export, target-size/reduced-motion contracts | 5 SP; Outfit, accessible pressables and bounded haptic intensity; rebase before every commit |
