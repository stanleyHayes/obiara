...
| S4-005 | S2-016 follow-up: wire privacy processor into worker with cross-context export/erasure | 4 | `/root/client_quality` | DONE | `services/worker/internal/jobs/`, `services/api/internal/privacy/` and narrow API-owned worker factory | claimed/completed 2026-07-26; depends S2-016/S1-009 | focused race; Mongo Testcontainers export/replay/legal-hold/erasure/audit/revocation proof; full Go test/vet | Bounded resumable worker; explicit cross-context allowlist; 7-day archive TTL; legal-hold recheck; opaque archive ref and pseudonymous receipt; no duplicate Doorway context |
...
| S4-009 | E06-S06 Decline, 90-day exclusion and kind notification | 3 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/seed/decline/` bounded context | claimed 2026-07-26 after S4-007 | GoMock, race/property and Mongo Testcontainers exclusion/replay/privacy proofs pending | Kind neutral notification; exact 90-day exclusion enforced server-side; no reason or rejection signal disclosed |
...
| S4-014 | E06-S12 Cross-context property/fuzz/chaos suite for Seed hard invariants | 5 | `/root/consent_kernel` | IN PROGRESS | `services/api/internal/seed/invariants/` black-box test package only | claimed 2026-07-26 after S4-001–S4-013 implementations | deterministic cross-context model, fuzz/replay/concurrency suite and full Go verification pending | No production code or shared adapters; prove no spend-before-acceptance, no early eligibility, no cap/alternation/mutuality bypass and privacy-safe terminal states |
...
| S5-001 | E07-S01 Courtship room event/state model and projection | 5 | `/root/mobile_gestures` | IN PROGRESS | isolated `services/api/internal/courtship/room/` bounded context | claimed 2026-07-26 after S4-010/S4-011 | GoMock, race/property and Mongo Testcontainers projection/privacy proofs pending | Private two-member room, append-only events and deterministic projection; no public activity, popularity or reverse lookup |
| S5-002 | E07 client private-room timeline, guided arc and calm action states | 5 | `codex-root` | IN PROGRESS | web `/fie/dan-mu/rooms/[roomId]` and equivalent Expo room presentation | claimed 2026-07-26 after S3-007/S4-008 and alongside isolated S5-001 server model | deterministic interaction tests; web/mobile typecheck/lint/build; desktop/390 rendered accessibility QA pending | Voice-first alternating timeline, clear next-turn/pause/closure/safety controls, no streak/read pressure/public activity; Outfit |
