...
| S8-033 | E15-S04 append-only suban event ledger with recomputable marks | 12 | `/root/backend_analytics` | IN PROGRESS | `services/api/internal/suban/`, marks/events routes + OpenAPI | claimed 2026-07-26; no suban writers exist | decay/mark computation + append-only integration pending | — |
| S8-034 | E14-S01 product/SKU rules proving seeds and visibility are unsellable | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/commerce/catalog/` domain/application/persistence boundary; no checkout, payment or marketplace profile ownership | claimed 2026-07-26 after S8-028 victim-export lane release | GoMock, product-law/property/race and live MongoDB Testcontainers catalog/version/privacy proofs pending | Versioned allowlisted product kinds and prices; reject seeds, approaches, visibility, rank, matching advantage, suban/trust, urgency and member-transfer value at every write/read boundary | No purchasable romantic access, pay-to-rank, mutable published price, hidden fee, member transfer, checkout/provider call or product-content coupling |
| S8-035 | E14-S06 client matchmaker discovery and consent-led booking | 5 | `codex-root` | IN PROGRESS | guarded web/Expo licensed-matchmaker marketplace with shared pure reducer; no calendar, MoMo, escrow, provider or server mutation | claimed 2026-07-26 after S8-032 notification client closure | web/mobile license/filter/fee/booking/proposal-consent and rendered interaction proofs pending | Licensed profiles, languages/specialties, banded fees, post-engagement-only ratings, consult intent and mutual consent before curated-candidate exposure | No global member browse, purchasable approach, candidate exposure before both consents, transactional review pressure, hidden fee, seed/visibility sale or fake scarcity |
| S8-036 | E14-S02 MoMo provider adapter and USSD-push intent boundary | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/commerce/momo/` domain/application/persistence boundary with provider port; no ledger, catalog or checkout UI ownership | claimed 2026-07-26 after S8-031 engagement-policy lane release | GoMock, signed/idempotent webhook, intent-state/property/race and live MongoDB Testcontainers proofs pending | Server-created bounded GHS collection intent, explicit member confirmation state, provider-neutral request/reference, signed replay-safe callbacks and append-only status audit | No raw phone in durable domain, member transfer, silent charge, seeds/visibility SKU, unsigned callback, amount mutation, success-before-provider confirmation or real provider call |
