...
| S8-039 | E14-S08 admin finance reconciliation, exports and four-eyes pricing | 5 | `codex-root` | IN PROGRESS | `apps/admin/app/finance/` MUI route with pure reducer fixtures/dashboard entry; no provider, ledger, pricing or export mutation | claimed 2026-07-26 after S8-035 marketplace client closure | reducer, separation-of-duty, reconciliation/export/redaction and admin rendered/type/lint/build proofs pending | Redacted provider-vs-ledger reconciliation, exception triage, bounded export purpose, pricing proposal plus distinct second approver and immutable preview | No single-person price publish, raw phone/member/payment data, balance edit, provider mutation, seed/visibility pricing, hidden fee, automatic reconciliation or destructive export |
| S8-040 | E14-S03 immutable double-entry ledger domain | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/commerce/ledger/` domain/application/persistence boundary; no provider, catalog or admin UI ownership | claimed 2026-07-26 after S8-034 catalog lane release | GoMock, balance/conservation/idempotency/property/race and live MongoDB Testcontainers posting/privacy proofs pending | Balanced append-only journal, bounded currencies/minor units, immutable entries, idempotent posting, account-class law and recomputable balances | No edit/delete, single-entry posting, member transfer, negative/overflow amount, hidden fee, provider call, raw member/payment data or cached-authority balance |
| S8-041 | E14-S05 membership/pass grace, cancellation, receipt and refund domain | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/commerce/membership/` domain/application/persistence boundary; no ledger, provider, catalog or client UI ownership | claimed 2026-07-26 after S8-036 MoMo lane release | GoMock, lifecycle/idempotency/property/race and live MongoDB Testcontainers concurrency/privacy proofs pending | Versioned pass grant, explicit paid-through date, bounded grace, member cancellation, opaque receipt/refund references, provider-confirmed refund state and append-only audit | No romance-access guarantee, seeds/visibility/rank sale, silent renewal, punitive cancellation, refund-before-confirmation, raw payment/member data, provider call or mutable historical term |
| S8-038 | E16-S01 admin principals, roles and MFA step-up backend | 10 | `/root/backend_admin` | IN PROGRESS | `services/api/internal/admin/`, admin auth routes + OpenAPI | claimed 2026-07-26; unblocks least-privilege desks (FR-801) | enrollment audit + step-up integration pending | — |
