...
| S5-016 | Integration repair: Pause Stone Mongo append arrays | 1 | `codex-root` | IN PROGRESS | `services/api/internal/courtship/pause/adapters/outbound/mongodb/` | claimed 2026-07-26 after recovered Docker run found null event/command arrays | focused MongoDB 8.0.13 Testcontainers and full Go/vet pending | New pause documents persist appendable empty arrays so immediate suspension and mutual resume remain atomic |
