...
| S7-025 | E12-S02 Tiered T&S queues and SLA routing | 10 | `/root/backend_safety` | IN PROGRESS | `services/api/internal/safety/` (cases), `services/worker/internal/jobs/safety/` | claimed 2026-07-26; continues S7-023 intake; no safety/ overlap with active lanes | SLA deadline + queue integration pending | — |
