...
| S0-004 | Current stable/compatible toolchain and dependency matrix | 0 | `codex-root` | IN PROGRESS | root toolchain manifests, dependency ADR | claimed 2026-07-26 | install/build resolution | Version discovery started; compatibility validation pending |
