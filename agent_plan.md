...
| S8-061 | E18-S04+S05 admin staffing coverage, launch calendar, density gates and waitlist throttle | 5 | `codex-root` | IN PROGRESS | extend `apps/admin/app/launch/` with pure aggregate coverage/calendar/throttle proposal; no scheduling, waitlist, notification or launch-state mutation | claimed 2026-07-27 after S8-059 readiness desk closure | admin staffing coverage/density/calendar/reason/throttle and rendered semantic/overflow proofs pending | Verification and support coverage show exact staffed/required seats, calendar exposes unresolved gates, and waitlist throttle proposal requires low-density evidence plus bounded reason; review cannot open a market or message members | No staff identity/performance score, silent understaffing pass, growth pressure, member/contact list, arbitrary throttle, automatic waitlist/launch mutation, notification send, hidden denominator or density bypass |
| S8-039 | E09-S07 ember-close transaction: fire dims to embers with frozen attendance | 9 | `/root/backend_fires` | DONE | `services/api/internal/fire/` (close flow), close route + OpenAPI | claimed/completed 2026-07-26 | -race integration: non-host rejected (FR-401), host close dims to embers, roster frozen at capacity, admissions rejected after close; domain state tests (host-only, embers not re-closable, live close allowed); Redocly + client regen + drift green | Self-reviewed; waitlisted members are excluded from the frozen roster (going only); cancellation-after-close policy noted for host-controls follow-up |
