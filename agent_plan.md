...
| S4-008 | E06-S09 client Garden lifecycle, expiries and dawn summary | 5 | `codex-root` | IN PROGRESS | web `/fie/garden/` lifecycle views and equivalent Expo state presentation | claimed 2026-07-26 after S4-003; UI lane isolated while S4-004/S4-006/S4-007 services progress | deterministic lifecycle tests; web/mobile typecheck/lint/build; desktop/390 accessibility and rendered-state QA pending | Calm non-addictive summary; explicit queued/delivered/heard/sprouted/declined/expired states; privacy-safe copy, no streaks/urgency/dark patterns |
