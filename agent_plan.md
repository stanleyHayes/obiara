...
| S7-023 | E12-S01 Universal report/block intake backend | 10 | `/root/backend_safety` | IN PROGRESS | `services/api/internal/safety/` (reports + blocks), HTTP routes + OpenAPI | claimed 2026-07-26; safeguarding is age-gate only, T&S intake unowned | unit + integration + contract tests pending | — |
