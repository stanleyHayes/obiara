...
| S8-023 | E12-S07 women’s-safety review evidence | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/safety/womensreview/` aggregate/evidence boundary; no member content store or automatic enforcement | claimed 2026-07-26 after E12-S01/S02 and S8-013 redacted evidence contract; renumbered after external S8-020 claim | GoMock, evidence/property/fuzz/race and persistence applicability proofs pending | Versioned reviewed evidence dimensions, representative minimum cohort, bounded redacted aggregates, women-reviewer approval and documented gaps; no raw content/identity, token review, false representativeness, automatic action, hidden score or subgroup exposure |
| S8-024 | E12-S08 admin incident response and regulatory runbooks | 5 | `codex-root` | IN PROGRESS | new `apps/admin/app/incidents/` MUI route with pure reducer fixtures; no pager/provider/regulator mutation | claimed 2026-07-26 after S8-013/S15 admin desk foundations; renumbered after external S8-020 claim | reducer/role/checkpoint/regulatory-export tests plus admin typecheck/lint/build and rendered browser proofs pending | Versioned runbook, declared commander/recorder, ordered checkpoints, severity-specific notification clock and redacted regulator packet confirmation; no silent severity change, skipped mandatory step, raw member data, unilateral close or automatic external notification |
...
| S8-025 | E12-S09 retention, erasure and transparency-report data | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/compliance/retention/` policy/application/persistence boundary; no product-content ownership | claimed 2026-07-26 after S8-017 anomaly lane release | GoMock, retention/erasure/aggregate/property/race and live MongoDB Testcontainers proofs pending | Versioned per-data-class retention, legal-hold precedence, verified erasure workflow, opaque aggregate transparency counters and audit trail; no silent deletion, hold bypass, raw-member report data, reversible erasure claim or cross-purpose reuse |
