...
| S8-055 | E16-S06 market-pack and terminology governance backend | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/governance/marketpack/` domain/application/persistence boundary; no runtime i18n registry, deployment or admin UI ownership | claimed 2026-07-27 after E16-S06 admin review desk closure; Doc 10 terminology registry and professional/community/in-context review pipeline inspected | GoMock, immutable-version/parity/placeholder/review/approval/property/race/fuzz and live MongoDB Testcontainers concurrency/idempotency/privacy proofs pending | Immutable complete keyset versions, exact placeholder parity, registered terminology/do-not-translate law, professional translation plus community and in-context human reviews, substantive acknowledgement and distinct second approval before publish-ready | No machine translation as truth, missing/extra key, placeholder drift, same-person approval, silent fallback approval, automatic registry overwrite/deploy/market activation, free-text content store or culturally unreviewed terminology |
...
| S8-057 | E16-S03 admin community, circle, host and fire operations | 5 | `codex-root` | IN PROGRESS | `apps/admin/app/community/` MUI operations desk with pure redacted fixtures and dashboard entry; no circle, host, fire, notification or member mutation | claimed 2026-07-27 after community/host/fire domain and admin-auth closures | admin density/host-eligibility/fire-reason/notice-preview and rendered semantic/overflow proofs pending | Redacted circle density and capacity state, current host verification/certification, bounded fire action reason and participant-notice preview required before an operations proposal; immutable references remain visible | No member/content/contact exposure, unverified host assignment, silent fire cancellation, automatic community change, capacity bypass, global browse, retaliation, notification send or source-state overwrite |
| S8-039 | E09-S07 ember-close transaction: fire dims to embers with frozen attendance | 9 | `/root/backend_fires` | DONE | `services/api/internal/fire/` (close flow), close route + OpenAPI | claimed/completed 2026-07-26 | -race integration: non-host rejected (FR-401), host close dims to embers, roster frozen at capacity, admissions rejected after close; domain state tests (host-only, embers not re-closable, live close allowed); Redocly + client regen + drift green | Self-reviewed; waitlisted members are excluded from the frozen roster (going only); cancellation-after-close policy noted for host-controls follow-up |
