...
| S2-022 | E03-S09 Doorway Question and photo vault/veil | 2 | `/root/client_quality` | IN PROGRESS | recover `/private/tmp/obiara-s2-022/services/api/internal/doorway/`, rebase and finish HTTP/OpenAPI contract | reassigned 2026-07-26 after prior owner left an uncommitted isolated worktree 34 commits behind | inspect existing diff first; unit, race, integration, contract, Redocly/client drift and full Go tests pending | Preserve prior work, opaque media refs, field visibility/consent and no raw vault media; rebase before commit and hand off without pushing |
...
| S4-001 | E06-S01 Immutable weekly allowance ledger and renewal | 5 | `/root/consent_kernel` | IN PROGRESS | new isolated `services/api/internal/seed/allowance/` bounded context | claimed 2026-07-26 after E05 trust/circle foundations | immutable issuance/spend/renewal, time-boundary, replay/concurrency, property and Mongo Testcontainers tests pending | Server-authoritative non-purchasable allowance, exact weekly renewal, append-only audit and no balance bypass; rebase before every commit and hand off without pushing |
| S4-002 | E06-S02 Introduction-source abstraction without global browsing | 3 | `/root/mobile_gestures` | IN PROGRESS | new isolated `services/api/internal/seed/source/` bounded context | claimed 2026-07-26 after S3-013/S3-015 | source policy, consent/visibility, bounded candidates, replay/property and Mongo Testcontainers tests pending | Explicit sources only, no global member list/reverse graph, bounded privacy-safe candidates and deterministic denial; rebase before every commit and hand off without pushing |
| S4-003 | E06 client garden, listening eligibility and deliberate sow composer | 5 | `codex-root` | IN PROGRESS | new member web `/fie/garden/` route and interaction model, then equivalent Expo route | claimed 2026-07-26 after E04 client shell and E03 voice introduction | 20-second eligibility, deliberate composer, allowance/queued/error states, typecheck/build and desktop/390 rendered QA pending | No global browsing, no spend before server confirmation, voice-first deliberate send, clear weekly allowance and no paid/boost language; rebase before every commit |
