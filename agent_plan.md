...
| S8-055 | E13-S06 Nnoboa nomination and auntie consent backend | 12 | `/root/backend_notifications` | IN PROGRESS | `services/api/internal/companions/nnoboa/` | claimed 2026-07-26; client surface (S8-029) done, backend unclaimed | nomination lifecycle + consent integration pending | — |
