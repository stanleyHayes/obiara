...
| S6-006 | E08-S05 Reviewer links, OTP, watermark and expiry | 5 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/cloth/reviewer/` bounded context | claimed 2026-07-26 alongside S6-005 consent policy | GoMock, property/race and Mongo Testcontainers OTP/single-use/expiry/revoke/privacy proofs pending | 256-bit opaque invite, separately delivered one-time OTP, short bounded expiry, consent revalidation and reviewer-specific watermark; no bearer-only access, browsing or link reuse |
...
| S6-008 | E08-S06 Per-question consent relay | 5 | `/root/courtship_closure` | IN PROGRESS | isolated `services/api/internal/cloth/relay/` bounded context | claimed 2026-07-26 after S6-005 | GoMock, property/race and Mongo Testcontainers per-question grant/revoke/redaction/privacy proofs pending | Reviewer submits bounded questions; each pair member independently consents to each response; relay reveals only the current dual-consent intersection and redacts immediately on revoke |
| S6-009 | E08-S07 Gate ceremony and optional circle announcement | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/cloth/ceremony/` bounded context | claimed 2026-07-26 after S6-005/S6-007 | GoMock, property/race and Mongo Testcontainers dual-confirmation/announcement/privacy proofs pending | Ceremony completes only with both members; circle announcement is separately optional, destination-bounded and dual-consented; no relationship detail, reviewer material or automatic publication |
| S6-010 | E08-S08 Harvest/weaver specification and order handoff | 5 | `codex-root` | IN PROGRESS | `services/api/internal/cloth/harvest/` plus durable weaver handoff specification | claimed 2026-07-26 after S6-001/S6-002/S6-004 | GoMock, property/race and Mongo Testcontainers consent/idempotency/privacy proofs pending | Pair-authorized immutable recipe handoff contains production-safe render tokens and opaque delivery ref only; no raw reflection, address, payment, public listing or vendor access beyond the order |
