...
| S7-006 | E10-S01 Oware domain rules and legality engine | 9 | `/root/backend_games` | DONE | `services/api/internal/games/oware/` (domain + legality only; persistence is E10-S02) | claimed/completed 2026-07-26 | rule unit tests (sow, capture chain, feed rule, threshold win, grand-slam suppression); property suites: 100 random alternating games conserve exactly 48 seeds with non-negative houses and decided winners, 200-trial grand-slam property (no capture ever empties the opponent) | Self-reviewed; abapa variant: skip-origin long sowing, 2-or-3 capture chain, feed rule, >24 win, leftover scoring; engine is pure domain — persistence/timers (E10-S02) and Glicko-2 (E10-S03) untouched |
| S7-007 | E09-S08 Incident hotkey and trust-and-safety live routing | 5 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/fire/incident/` bounded context | claimed 2026-07-26 after S6-003/S7-002 | GoMock, property/race and Mongo Testcontainers routing/idempotency/privacy proofs pending | Any participant can trigger a private bounded-category incident; immediate safety action is independent of host; one opaque case routes to authorized T&S with minimal live context and no public accusation |
| S7-008 | E09-S09 client in-app call without phone-number exposure | 5 | `codex-root` | IN PROGRESS | web/Expo private-room call proposal, consent and active-call states | claimed 2026-07-26 after S5-009 proposal lifecycle and alongside S7-001 realtime adapter | model/UI tests; web/mobile typecheck/lint/build; desktop/mobile accessibility/browser QA pending | Recipient explicitly accepts a private audio/video proposal before join; call uses Obiara names only, never phone/email/contact discovery; safety, captions and leave remain available |
| S7-009 | E09-S10 Fire load, device and constrained-network acceptance harness | 5 | `/root/consent_kernel` | IN PROGRESS | isolated Fire acceptance tooling and evidence under `internal/quality/` with only minimal test seams in Fire packages | claimed 2026-07-26 after S7-001–S7-006; independent of active incident and client-call lanes | deterministic 150-seat/load simulation, device matrix, 3G degradation and safety-control evidence pending | Acceptance must measure rather than claim capacity; no production load, no real member data, no weakened consent/safety controls and no nondeterministic internet dependency |
