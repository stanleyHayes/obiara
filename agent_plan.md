...
| S3-005 | E04-S05 Adiwo circle courtyard shell | 3 | `codex-root` | IN PROGRESS | new `apps/web/app/fie/adiwo/` route and interaction model using shared compound navigation | claimed 2026-07-26 after S3-004 and S3-010/S3-012 | membership-state tests, typecheck/lint/build and desktop/390 rendered QA pending | Familiar circles, host-led events and membership-safe actions; private membership details stay bounded; rebase before every commit |
