...
| S8-049 | E15-S06 member Suban explanation and appeal domain | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/suban/explanation/` domain/application/persistence boundary; no mark formula, safety ruling or client UI ownership | claimed 2026-07-27 after S8-033 append-only/recomputable Suban closure; Doc 08 member-event visibility and Doc 09 panel appeal governance reviewed | GoMock, ownership/projection/appeal/property/race/fuzz and live MongoDB Testcontainers concurrency/idempotency/privacy proofs pending | Member-owned bounded event explanation shows thresholded mark provenance without a number; adverse event appeals preserve the source event and require distinct authorized human resolution with immutable reasoning ref | No other-member view, numeric/hidden score, raw evidence/content, event deletion/edit, automatic mark/ruling change, self-review, matching/rank/visibility export or model/vendor decision |
...
| S8-039 | E09-S07 ember-close transaction: fire dims to embers with frozen attendance | 9 | `/root/backend_fires` | IN PROGRESS | `services/api/internal/fire/` (close flow) | claimed 2026-07-26; fire lane free (S6-003, S4-015 by this agent) | close + ember-session integration pending | — |
