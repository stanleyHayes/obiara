...
| S2-004 | E01-S03 Distinct admin theme and operator primitives | 2 | Unassigned | READY | `packages/ui-web/src/admin*`, `apps/admin/app/layout.tsx` | Depends S2-001, S2-003 (done) | admin build/typecheck; density, status, focus and contrast tests | 3 SP; distinct provider on shared brand tokens |
