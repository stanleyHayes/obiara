...
| S4-005 | S2-016 follow-up: wire privacy processor into worker with cross-context export/erasure | 4 | Unassigned | BACKLOG | `services/worker/internal/jobs/`, `services/api/internal/privacy/` | Depends S2-016 (done), S1-009 (done) | export archive assembled, erasure executes via worker job | — |
