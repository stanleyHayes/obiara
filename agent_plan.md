...
| S8-048 | E15-S06 client suban explanation and appeal view | 5 | `codex-root` | IN PROGRESS | guarded web/Expo member accountability surface with shared pure projection; no event ledger, mark calculation, panel ruling or server mutation | claimed 2026-07-27 after S8-033 append-only suban ledger closure | web/mobile event explanation, decay, appeal and rendered interaction proofs pending | Every visible mark traces to bounded member-visible events, weight and decay; findings suppress visibly; reason-gated appeal creates opaque reference without changing history or deciding outcome | No cached authority, hidden score, raw safety evidence, third-party identity, automatic mark edit, appeal overwrite, ranking/matching effect, pressure or gamified streak |
