...
| S2-003 | E01-S02 Member MUI theme and shared web primitives | 2 | Unassigned | READY | `packages/ui-web/` | Depends S2-001 (done) | theme, keyboard/focus, target-size and reduced-motion tests; build | 5 SP; stable exported API and Outfit typography |
...
| S2-005 | E01-S04 Expo theme and base interaction primitives | 2 | Unassigned | READY | `packages/ui-mobile/`, `apps/mobile/app/_layout.tsx` | Depends S2-001 (done) | React Native tests, Expo export, target-size/reduced-motion contracts | 5 SP; Outfit, accessible pressables and bounded haptic intensity |
