...
| S0-005 | Monorepo and application/service skeletons | 0 | Unassigned | READY | root, `apps/`, `services/`, `packages/` | — | clean bootstrap/check/build | Depends on published S0-004 matrix |
