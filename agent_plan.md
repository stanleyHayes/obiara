...
| S0-009 | Admin shell signature UI prototype | 0 | `codex-root` | IN PROGRESS | `apps/admin/`, shared UI primitives | claimed 2026-07-26 | type/lint/build and rendered QA | Codex UI lane; operator-first shell |
