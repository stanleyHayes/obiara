...
| L1-001 | Post-backlog launch-gate inventory and claim-safe execution ledger | Launch 1 | `codex-root` | IN PROGRESS | `agent_plan.md`, repository launch evidence inventory | claimed 2026-07-27 after S8-075 closure; repository-controlled work only | Pending inventory reconciliation and ledger review | Production remains blocked; no approval, provider, credential, cohort, store or deployment action is implied |
| L1-002 | Executable production-gate and evidence registry | Launch 1 | `/root/consent_kernel` | IN PROGRESS | isolated `internal/quality/launchgates/` package, schemas/fixtures under `deploy/release/`; no admin UI or external mutation | claimed 2026-07-27 after L1-001 scope definition | Pending Go unit/property tests and strict fixture validation | Must distinguish repository evidence from external decision evidence and fail production closed |
| L1-003 | Launch-gate security and privacy policy cross-review | Launch 1 | `/root/security_closure` | IN PROGRESS | isolated launch-gate policy tests/review note; no production scan, provider call or approval mutation | claimed 2026-07-27 after L1-002 boundary definition | Pending adversarial policy cases and review note | Review-only lane may add bounded corrections but cannot mark external gates satisfied |
| L1-004 | Admin launch-decision readiness surface | Launch 1 | `codex-root` | READY | `apps/admin/app/launch/`, shared admin presentation primitives only | ready after L1-002 registry contract | Pending model/UI tests, typecheck, lint, build and rendered desktop/mobile QA | Codex owns primary UI implementation; surface must expose exact owner, evidence freshness, dependency and blocker state without a launch button |
| L1-005 | Exact-SHA synthetic staging qualification package | Launch 1 | `/root/client_quality` | IN PROGRESS | isolated staging qualification generator/validator and synthetic artifact; no Render/provider/store action | claimed 2026-07-27 after S8-072/S8-075 | Pending exact-SHA deterministic validation and repository checks | Synthetic staging evidence only; must never be accepted as production, legal, provider or cohort evidence |
| L1-006 | Launch 1 integrated cross-review, full quality gate and publish | Launch 1 | `codex-root` | READY | repository-wide verification, review notes and task ledger | ready after L1-002 through L1-005 | Pending full `pnpm run check`, rebase and remote parity | Direct-to-main publish only after all repository-controlled acceptance criteria pass |
