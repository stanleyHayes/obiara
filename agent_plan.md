...
| S2-001 | E01-S01 Complete platform-neutral brand tokens and asset manifest | 2 | Unassigned | READY | `packages/design-tokens/` | E01 audit completed 2026-07-26 | token unit/type/contrast tests; workspace checks | 5 SP; preserve Outfit override; tokens must remain consumable by web and React Native without DOM types |
