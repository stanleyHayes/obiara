...
| S8-016 | E12-S05 admin care queue and approved resource-first scripts | 5 | `codex-root` | IN PROGRESS | new `apps/admin/app/care/` MUI route with pure reducer fixtures; no clinical record, diagnosis or outbound provider | claimed 2026-07-26 after E12-S02 queue routing and S8-013 desk conventions | reducer/script/consent/follow-up tests plus admin typecheck/lint/build and rendered browser proofs pending | Least-exposure care cases, approved versioned resource scripts, member contact preference and explicit human send confirmation; no diagnosis, therapy claim, coercive contact, punitive safety action, raw counsel content or automated crisis adjudication |
