...
| S0-003 | ADR set: monorepo, Go hexagon, Mongo, REST/OpenAPI, Expo, Render | 0 | `/root/backend_architecture` | DONE | `internal/architecture/` | claimed/completed 2026-07-26 | Six accepted ADRs indexed and manually checked for source/plan consistency | Self-reviewed; substitutions, constraints, consequences and measurable revisit triggers recorded |
...
| S0-007 | Go hexagonal module template and Mongo/Testcontainers spike | 0 | Unassigned | BACKLOG | `services/api/`, `services/worker/` | Depends S0-005 | unit + real Mongo Testcontainer integration | — |
