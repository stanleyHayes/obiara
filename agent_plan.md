...
| S6-005 | E08-S04 Abusua Gate consent configuration | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/cloth/gate/` bounded context | claimed 2026-07-26 after S6-001/S6-002 | GoMock, property/race and Mongo Testcontainers dual-consent/revoke/privacy proofs pending | Pair members explicitly configure who may review which question/material; deny by default, most-restrictive merge and immediate revocation; no inherited circle access or public link |
...
| S6-007 | E08 client Abusua Gate consent and reviewer ceremony | 5 | `codex-root` | IN PROGRESS | new guarded web/Expo Gate route and pair consent/reviewer states | claimed 2026-07-26 after Fie shell and S6-001/S6-002 | model/UI tests; web/mobile typecheck/lint/build; desktop/mobile accessibility/browser QA pending | Explain dual consent, selected material, OTP and expiry without exposing private content; Outfit, calm ceremony language, no public-share framing |
