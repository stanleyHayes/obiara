...
| S8-006 | E13-S05 WhatsApp OTP and pod alerts | 10 | `/root/backend_notifications` | IN PROGRESS | `internal/notifications/whatsapp/` | claimed 2026-07-26; notifications lane free (ritual/preferences done by this agent) | provider-port contract + simulator tests + integration pending | — |
| S8-007 | E11-S05 model/ranker readiness, offline evaluation and fairness gates | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/matching/evaluation/` readiness/evaluation boundary; no online ranker or vendor invocation | claimed 2026-07-26 after S8-001/S02/S04; matching features lane released | GoMock, deterministic/property/race and persistence applicability proofs pending | Readiness must remain closed until versioned consented feature snapshots, minimum cohort/evidence thresholds, offline quality/fairness bounds and human approval all pass; no production ranking, inferred traits or unbounded group slicing |
| S8-008 | E11-S07 counsel isolation from matching | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/counsel/isolation/` policy/application boundary plus compile-time dependency proof | claimed 2026-07-26 after S8-004/S05 client disclosure; counsel lane free | GoMock, isolation/property/race and persistence applicability proofs pending | Counsel content, topics, attendance and outcomes cannot enter matching features, explanations, ranking, trust or AI prompts; only explicit safety escalation may leave through a separately authorized minimal event |
...
| S8-010 | E11-S13 client AI model cards, red-team status and appeal transparency | 5 | `codex-root` | IN PROGRESS | new guarded web/Expo accountability surface under Okyeame using pure client projection; no model/vendor/admin data | claimed 2026-07-26 after S8-001/S05 and audited S8-009 | model-card/metric/appeal reducer tests, web/mobile quality and rendered browser proofs pending | Show versioned capability scope, consent basis, latest bounded evaluation/red-team state and human appeal route without hidden scores, group microtargeting, raw prompts, false certification or automatic appeal decisions |
