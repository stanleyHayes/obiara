...
| S2-010 | E01-S07 Component galleries and visual-regression gate | 2 | `codex-root` | IN PROGRESS | Storybook/config, `apps/mobile/app/gallery/`, visual-test configuration and baselines | claimed 2026-07-26 after S2-003 through S2-009 completion | deterministic desktop/390 snapshots, axe scans and CI artifacts | 8 SP; Outfit load must be stable; baselines require review rather than blanket updates; rebase before every commit |
...
| S2-014 | E03-S05 Under-18 hard block and 24-hour purge proof | 2 | `/root/consent_kernel` | IN PROGRESS | `services/api/internal/verification/` | claimed 2026-07-26 after S2-013 completion; coordinate with active S2-015 verification lane | purge-proof integration test | Backend lane must isolate files from S2-015, rebase before every commit and hand off without pushing |
...
| S2-017 | E03-S07 Core profile and privacy controls | 2 | Unassigned | READY | `services/api/internal/profile/` | Depends S1-002 (done) | profile boundary tests | — |
| S2-018 | E03-S04 Voice+face liveness orchestration and uncertainty handling | 2 | Unassigned | BACKLOG | `services/api/internal/verification/` | Depends S2-014 (owns verification/) | liveness adapter contract tests | — |
| S2-019 | E03-S12 Shared-device/collision and known-name review cases | 2 | Unassigned | READY | `services/api/internal/identity/` | Depends S2-011 (done) | collision case tests | — |
