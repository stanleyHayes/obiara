...
| S2-004 | E01-S03 Distinct admin theme and operator primitives | 2 | `codex-root` | IN PROGRESS | `packages/ui-web/src/admin*`, `apps/admin/app/layout.tsx` | claimed 2026-07-26 after S2-003 | admin build/typecheck; density, status, focus and contrast tests | 3 SP; distinct provider on shared brand tokens; rebase before every commit |
