...
| S8-010 | E13-S04 Resend email: templates, sender port, signed delivery webhooks | 10 | `/root/backend_notifications` | IN PROGRESS | `internal/notifications/email/`, webhook route + OpenAPI | claimed 2026-07-26; notifications lane continuation | signature/timestamp verification + dedup integration pending | — |
...
| S8-014 | E11-S11 scam-arc sequence signals and action ladder | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/safety/scamarc/` aggregate/evaluation boundary; no message store, payment access or automatic enforcement | claimed 2026-07-26 after S8-001/S05/S10 contract definition; seed screening lane released | GoMock, sequence/property/fuzz/race and persistence applicability proofs pending | Bounded opaque event sequence and versioned reviewed rules produce neutral human-review signals with escalating least-harm recommendations; no raw content, accusation, hidden member score, auto-block/payment action, single-event conviction or model-final decision |
| S8-015 | E12-S04 admin action ladder and propagated-control confirmation | 5 | `codex-root` | IN PROGRESS | extend `apps/admin/app/safety/` pure reducer/MUI desk only; no backend enforcement or device mutation | claimed 2026-07-26 after S8-013 redacted evidence ceremony | reducer/least-harm/confirmation/appeal tests plus admin typecheck/lint/build and rendered browser proofs pending | Human proposes warning, temporary surface restriction or bounded account review in increasing order; explicit scope/reason/confirmation and appeal notice required; no auto-escalation, permanent ban default, device-wide action, payment action, accusation or silent propagation |
