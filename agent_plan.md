...
| S1-010 | E02-S10 Media abstraction, signed access and retention metadata | 1 | codex-root + /root/media_kernel | IN PROGRESS | `services/api/internal/media/` | Depends S1-003 (done) | signed-access contract tests | Claimed 2026-07-26; isolated backend lane excludes active worker/shared-platform relocation; rebase before every commit |
...
| S2-001 | E01-S01 Complete platform-neutral brand tokens and asset manifest | 2 | `codex-root` | IN PROGRESS | `packages/design-tokens/` | claimed 2026-07-26 after E01 audit | token unit/type/contrast tests; workspace checks | 5 SP; preserve Outfit override; tokens must remain consumable by web and React Native without DOM types; rebase before every commit |
| S2-002 | E01-S05 Typed EN/Twi string registry and terminology policy | 2 | Unassigned | READY | `packages/i18n/` | E01 audit completed 2026-07-26 | catalog parity/interpolation/fallback/terminology tests | 5 SP; record Twi community-review state and do not mark unapproved translations production-ready |
| S2-003 | E01-S02 Member MUI theme and shared web primitives | 2 | Unassigned | BACKLOG | `packages/ui-web/` | Depends S2-001 | theme, keyboard/focus, target-size and reduced-motion tests; build | 5 SP; stable exported API and Outfit typography |
| S2-004 | E01-S03 Distinct admin theme and operator primitives | 2 | Unassigned | BACKLOG | `packages/ui-web/src/admin*`, `apps/admin/app/layout.tsx` | Depends S2-001, S2-003 | admin build/typecheck; density, status, focus and contrast tests | 3 SP; distinct provider on shared brand tokens |
| S2-005 | E01-S04 Expo theme and base interaction primitives | 2 | Unassigned | BACKLOG | `packages/ui-mobile/`, `apps/mobile/app/_layout.tsx` | Depends S2-001 | React Native tests, Expo export, target-size/reduced-motion contracts | 5 SP; Outfit, accessible pressables and bounded haptic intensity |
| S2-006 | E01-S06 Localization, accessibility and copy-policy lint | 2 | Unassigned | BACKLOG | `packages/config-eslint/`, `packages/quality-client/`, relevant CI configuration | Depends S2-002 | failing fixtures for hardcoded copy, missing keys, bad placeholders and banned pressure patterns; CI proof | 5 SP; documented narrow escape hatch only for non-product data |
| S2-007 | E01-S08 Cross-platform loading, empty, error and offline patterns | 2 | Unassigned | BACKLOG | `packages/ui-web/src/states/`, `packages/ui-mobile/src/states/`, state catalogs in `packages/i18n/` | Depends S2-002, S2-003, S2-005 | deterministic web/RN state and assistive-technology tests | 5 SP; include queued, low-bandwidth and permission-denied states |
| S2-008 | E01-S09a Web Hold, Sow, Stone and Gather prototypes | 2 | Unassigned | BACKLOG | `apps/web/app/design-lab/`, web gesture primitives | Depends S2-002, S2-003, S2-007 | component interactions plus 390px/desktop browser QA | 8 SP; keyboard, pointer, screen-reader and reduced-motion equivalents required |
| S2-009 | E01-S09b Expo Hold, Sow, Stone and Gather prototypes | 2 | Unassigned | BACKLOG | `apps/mobile/app/design-lab/`, mobile gesture primitives | Depends S2-002, S2-005, S2-007 | RN interactions, Expo export and Android smoke | 8 SP; no gesture-only path; one-handed 48dp controls |
| S2-010 | E01-S07 Component galleries and visual-regression gate | 2 | Unassigned | BACKLOG | Storybook/config, `apps/mobile/app/gallery/`, visual-test configuration and baselines | Depends S2-003 through S2-009 | deterministic desktop/390 snapshots, axe scans and CI artifacts | 8 SP; Outfit load must be stable; baselines require review rather than blanket updates |
| S2-011 | E03-S01 Phone registration, OTP, rate limits and session issuance | 2 | `/root/backend_identity` | IN PROGRESS | `services/api/internal/identity/`, auth HTTP routes + OpenAPI | claimed 2026-07-26 after Sprint 2 refinement; dependency S1-005 complete | unit + Testcontainers integration + contract tests pending | — |
| S2-012 | E03-S02 Promise/terms/age consent record | 2 | Unassigned | READY | `services/api/internal/consent/` | Depends S1-002 (done) | purpose/version/revocation tests | — |
| S2-013 | E03-S06 Tier/account state machines and transition audit | 2 | Unassigned | BACKLOG | `services/api/internal/identity/`, `services/api/internal/member/` | Depends S2-011 | state-machine property tests | — |
