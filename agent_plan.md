...
| S3-008 | E04-S08 Okyeame presence point placeholder and capability boundary | 2 | `codex-root` | IN PROGRESS | new `apps/web/app/fie/okyeame/` route and capability-state model | claimed 2026-07-26 after S3-007 | capability/feature-state tests, typecheck/lint/build and desktop/390 rendered QA pending | Resting capability is explicit, never impersonates a person or promises unavailable automation, and always returns safely to Fie; rebase before every commit |
