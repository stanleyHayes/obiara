...
| S8-046 | E12-S05 care queue with resource-first scripts and closure quietening | 10 | `/root/backend_safety` | IN PROGRESS | `internal/safety/` (care), notifications quietening read | claimed 2026-07-26; safety lane continuation | immediate routing + quietening integration pending | — |
