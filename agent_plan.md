...
| S8-021 | E12-S04 Action ladder and propagated account/device controls | 10 | `/root/backend_safety` | IN PROGRESS | `internal/safety/` (actions), identity status transitions, `services/worker/internal/jobs/safety/` | claimed 2026-07-26; continues S7-026 queues | ladder validation + propagation integration pending | — |
...
| S8-028 | E12-S11 fraud-victim evidence export domain | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/safety/victimexport/` domain/application/persistence boundary; no evidence-content store or outbound delivery | claimed 2026-07-26 after S8-025 retention lane release | GoMock, authorization/redaction/expiry/revocation/property/race and live MongoDB Testcontainers proofs pending | Member-requested allowlisted opaque references, reporter/third-party redaction, exact purpose, one-time/revocable 72-hour authorization and append-only audit; no raw evidence, accused/reporter identity, automatic delivery, perpetual token, case action or victim-blaming copy |
| S8-029 | E13-S06 client Nnoboa nomination and auntie consent flow | 5 | `codex-root` | IN PROGRESS | guarded web/Expo companion surfaces with shared pure projection/reducer; no WhatsApp provider, candidate discovery or server mutation | claimed 2026-07-26 after E12 admin client closure | web/mobile nomination, nominee-consent, veto, private-field projection and interaction/browser proofs pending | Up to three member-designated nominators; bounded candidate reference; member absolute veto; nominee consent before reveal; nominators never see doorway/room content | No global browse, autonomous nomination, nominee exposure before consent, courtship conversation, private room/doorway content, engagement bait or pressure copy |
=======
| S8-017 | E11-S12 syndicate, vouch-ring and device anomaly detection | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/safety/anomaly/` offline aggregate/evaluation boundary; no graph browse, device fingerprint store or automatic enforcement | claimed 2026-07-26 after S8-005/S10 and S8-012 lane release | GoMock, graph/property/fuzz/race and persistence applicability proofs pending | Bounded opaque aggregates detect reviewed ring/device anomaly shapes for human review only; minimum cohort/evidence and precision gates; no raw graph/device ID, guilt by association, matching/trust score mutation, auto-block, payment action or model-final decision |
...
>>>>>>> f2dce25 (S8-021 T&S action ladder with propagated account, session and device controls)
