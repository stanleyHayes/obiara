...
| S5-005 | E07-S04 Response windows, resting, re-light and archival | 5 | `codex-root` | IN PROGRESS | isolated `services/api/internal/courtship/pace/` bounded context | reassigned 2026-07-26 after the prior agent returned only an incomplete domain draft | GoMock, race/property and Mongo Testcontainers time-boundary proofs pending | Calm response windows, mutual re-light, deterministic archive; no urgency/streak/read receipt |
