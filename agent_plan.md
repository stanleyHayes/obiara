...
| S8-051 | E15-S03+S07 admin phase-gate, fairness, regret and safety dashboard | 5 | `codex-root` | IN PROGRESS | `apps/admin/app/analytics/` MUI read-only aggregate dashboard with pure fixtures and dashboard entry; no analytics, safety, rollout or policy mutation | claimed 2026-07-27 after S8-047 phase-gate projection closure and alongside isolated S8-050 fairness projection | admin projection/incomplete-data/denominator/interpretation and rendered semantic/overflow proofs pending | Exact P0 gates and quarterly fairness/regret/safety aggregates show explicit numerators, denominators, evidence completeness and fail-closed release state; operator can record a bounded review note without changing facts | No raw member/content/protected-trait data, hidden denominator, automatic rollout/correction/enforcement, source edit, ranking score, false pass, micro-cohort or vanity chart |
| S8-039 | E09-S07 ember-close transaction: fire dims to embers with frozen attendance | 9 | `/root/backend_fires` | DONE | `services/api/internal/fire/` (close flow), close route + OpenAPI | claimed/completed 2026-07-26 | -race integration: non-host rejected (FR-401), host close dims to embers, roster frozen at capacity, admissions rejected after close; domain state tests (host-only, embers not re-closable, live close allowed); Redocly + client regen + drift green | Self-reviewed; waitlisted members are excluded from the frozen roster (going only); cancellation-after-close policy noted for host-controls follow-up |
