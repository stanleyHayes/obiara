...
| S0-009 | Admin shell signature UI prototype | 0 | `codex-ui` preferred | READY | `apps/admin/`, shared UI primitives | — | type/lint/build and rendered QA | Depends on published S0-008 |
