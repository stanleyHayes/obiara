...
| S0-006 | CI, security and supply-chain baseline | 0 | `/root/platform_scaffold` | IN PROGRESS | `.github/`, quality configs | claimed 2026-07-26 | local equivalents + workflow validation | Continuation after verified scaffold |
| S0-007 | Go hexagonal module template and Mongo/Testcontainers spike | 0 | `/root/backend_architecture` | IN PROGRESS | `services/api/`, `services/worker/`, Go module files | claimed 2026-07-26 | unit + real Mongo Testcontainer integration | Backend-only lane; no client edits |
| S0-008 | Outfit brand tokens and member web signature UI prototype | 0 | `codex-root` | IN PROGRESS | `apps/web/`, `packages/design-tokens/`, `packages/ui-web/` | claimed 2026-07-26 | type/lint/build, responsive browser and accessibility QA | Codex UI lane; rendered review required |
