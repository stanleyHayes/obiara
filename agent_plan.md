...
| S7-010 | E13-S01 Notification preference, quiet hours and six/day cap | 10 | `/root/backend_notifications` | IN PROGRESS | `services/api/internal/notifications/` | claimed 2026-07-26; fully independent of active lanes | cap/quiet-hours unit + integration tests pending | — |
| S7-011 | E10-S02 async Oware game, move timers and room embedding | 9 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/games/oware/session/` application/persistence slice; no client UI | claimed 2026-07-26 after S7-006; independent of Fire acceptance and private-call files | GoMock, timer/idempotency/race properties and live MongoDB Testcontainers proofs pending | Server-authoritative moves and bounded clocks; expiration never invents a move, retries never apply twice, room references stay opaque and no game outcome reaches matching visibility |
| S7-012 | E10-S03 Oware Glicko-2 ratings and notation | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/games/oware/rating/` pure rating/notation slice; no persistence or UI | claimed 2026-07-26 after S7-006; independent of S7-011 session persistence | reference-vector, property, fuzz and race proofs pending | Deterministic Glicko-2 periods and replayable notation; bounded inputs, no skill-to-matching export, no popularity ranking and no member-discovery surface |
| S7-013 | E10-S04 conduct-only suban integration | 5 | unassigned | READY | isolated `services/api/internal/games/conduct/` bounded context; no rating/matching coupling | released clean by `/root/courtship_closure` before implementation; ready for reassignment | GoMock, bounded-conduct/property/race and live MongoDB Testcontainers proofs pending | Suban records only conduct signals from bounded game events; never skill, win/loss, rating, popularity or matching visibility; appeals and provenance remain explicit |
