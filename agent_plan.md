...
| S3-001 | E04-S01 Fie information architecture and route map | 3 | `codex-root` | IN PROGRESS | `internal/product/fie-route-map.md` | claimed 2026-07-26 after E03 client foundation | route, tier, deep-link and offline guard matrix review | Must cover member web/mobile parity and keep admin routes separate; rebase before every commit |
