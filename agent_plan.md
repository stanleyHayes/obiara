...
| S7-017 | E13-S02 Dawn, Monday, fire and Sunday rituals | 10 | `/root/backend_notifications` | IN PROGRESS | `services/api/internal/notifications/ritual/`, `services/worker/internal/jobs/ritual/` | claimed 2026-07-26 after dropping raced S7-013 claim; renumbered from duplicate S7-014 | schedule unit tests + dispatch integration pending | — |
| S7-014 | E10 client Oware room and async move experience | 5 | `codex-root` | DONE | guarded web/Expo Oware room route, accessible board, turn/timer/notation and private room mount | 49 web tests; web/mobile typecheck/lint/build; rendered desktop interaction/semantic/overflow QA; `git diff --check` | Select-then-confirm move law; opponent/out-of-board selections rejected; 48-seed conservation and origin-skip proof; responsive Outfit board exposes explicit labels/status | Deliberate legal move selection, calm async timer and notation; no leaderboard, matching advantage, popularity pressure, phone/contact/public-attendance exposure or invented server result |
| S7-015 | E10-S05 reviewed Ɛbɛ duel domain and content catalog | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/games/ebe/` reviewed-content and duel domain; no client UI | claimed 2026-07-26 after E10 domain foundation; independent of active conduct lane | review-provenance, language/answer, replay/property/race and persistence applicability proofs pending | Only versioned reviewer-approved proverb prompts enter play; bounded answers and turns, immutable provenance, no free-form public publishing, matching/rating/popularity coupling or invented cultural authority |
...
| S7-019 | E10-S06 Anansesɛm relay and dual-consent publication domain | 5 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/games/anansesem/` domain/application/persistence; no client files | claimed 2026-07-26 after S7-018 contract; independent of active Ɛbɛ domain lane | GoMock, alternation/consent/redaction property/race and live MongoDB Testcontainers proofs pending | Strict alternating bounded passages; immutable draft provenance; any edit invalidates publication grants; only fresh dual consent produces a redacted edition with no room, contact or private authorship identifiers |
| S7-020 | E10-S07 client Ampe realtime pulse | 5 | `codex-root` | IN PROGRESS | guarded web/Expo private Ampe route with ready/choice/locked/simultaneous-reveal and low-bandwidth states | claimed 2026-07-26 after realtime and Games foundations; no backend file overlap | model/UI tests; web/mobile typecheck/lint/build; rendered accessibility/interaction/overflow QA pending | Explicit ready and private gesture choice; no camera/body inference; simultaneous reveal only after both locks; safety/leave and constrained-network recovery stay reachable; no public score or matching advantage |
| S7-021 | E10-S07 Ampe realtime round domain | 5 | unassigned | READY | isolated `services/api/internal/games/ampe/` server-authoritative round/realtime state; no client UI | ready after S7-001 realtime foundation and S7-020 client contract | GoMock, simultaneous-lock/reveal/idempotency/property/race and persistence applicability proofs pending | Opaque two-player room, bounded choices and server sequence; choices hidden until both lock; disconnect cannot forfeit or expose choice; no camera/body data, public score, matching/rating/trust coupling |
