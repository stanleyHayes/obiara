...
| S8-053 | E16-S06 market-pack governance with four-eyes publishing and configuration audit | 12 | `/root/backend_admin` | IN PROGRESS | `services/api/internal/marketpack/` | claimed 2026-07-26; config governance unclaimed | four-eyes publish + audit integration pending | — |
