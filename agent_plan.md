...
| S8-042 | E14-S06 matchmaker profiles, licensing and consent-led booking domain | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/commerce/matchmaker/` domain/application/persistence boundary; no payment, ledger, marketplace UI or member discovery ownership | claimed 2026-07-26 after S8-041 membership lane release | GoMock, license/fee/booking/dual-consent/property/race and live MongoDB Testcontainers proofs pending | Current license and fee-band validation, opaque member/candidate refs, consultation booking intent, milestone terms, dual consent before proposal exposure, completed-engagement-only review eligibility | No global member browse, candidate exposure before both consents, pay-to-approach, seeds/visibility/rank, unlicensed listing, pre-engagement rating, provider call or raw member/contact data |
| S8-043 | E14-S05 client membership, grace, cancellation, receipt and refund flow | 5 | `codex-root` | IN PROGRESS | guarded web/Expo membership settings with shared pure reducer; no provider, ledger, catalog, billing or server mutation | claimed 2026-07-26 after S8-039 finance admin closure | web/mobile term/grace/cancel/receipt/refund and rendered interaction proofs pending | Exact paid-through and renewal state, bounded grace explanation, non-punitive cancellation preserving purchased access, opaque receipt and provider-confirmed refund states | No romance-access guarantee, silent renewal, cancellation pressure, seeds/visibility/rank sale, refund-before-confirmation, raw payment data or fake urgency |
