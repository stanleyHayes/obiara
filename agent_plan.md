...
| S4-013 | E06-S11 Seed abuse controls, demand throttling and care-review signals | 5 | `codex-root` | IN PROGRESS | isolated `services/api/internal/seed/safety/` bounded context | claimed 2026-07-26 after S4-004/S4-006/S4-007 | GoMock, race/property and Mongo Testcontainers throttle/replay/privacy proofs pending | Server-authoritative bounded windows; generic denials; pseudonymous care signals only; no accusation, raw content, global graph or member-visible score |
