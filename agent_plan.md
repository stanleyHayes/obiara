...
| S0-006 | CI, security and supply-chain baseline | 0 | `/root/platform_scaffold` | DONE | `.github/`, `internal/quality/ci-security-baseline.md` | claimed/completed 2026-07-26 | actionlint passed; audit gate proved against 4 detected high transitive advisories; full frozen check awaits active S0-008 lock update | SHA-pinned Actions, least-privilege permissions, Dependabot and private reporting policy; advisories not waived |
