...
| S4-010 | E06-S07 Sprout and three-exchange alternating doorway | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/seed/sprout/` bounded context | claimed 2026-07-26 after S4-006/S4-007 | GoMock, race/property and Mongo Testcontainers turn-order/replay/privacy proofs pending | Mutual sprout only; exactly three alternating exchanges; opaque refs; no unilateral room creation or public relationship signal |
| S4-011 | E06-S08 Mutual water and single room creation under races | 5 | `/root/mobile_gestures` | IN PROGRESS | isolated `services/api/internal/seed/water/` bounded context | claimed 2026-07-26 after S4-007 | GoMock, race/property and Mongo Testcontainers mutuality/single-room proofs pending | Both members must water; concurrent commands create at most one private room; no public activity/reverse lookup |
| S4-012 | E06-S09 Server Garden states, expiries and dawn summary projection | 5 | `codex-root` | IN PROGRESS | isolated `services/api/internal/seed/garden/` bounded context | claimed 2026-07-26 after S4-004/S4-006/S4-007/S4-008 | GoMock, race/property and Mongo Testcontainers transition/expiry/privacy proofs pending | Deterministic queued/delivered/heard/sprouted/declined/expired projection; once-daily member-only summary; no read receipt, streak, reason or public activity leak |
