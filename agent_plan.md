...
| S7-005 | E09-S06 Fire consent and recording policy | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/fire/recording/` bounded context | claimed 2026-07-26 after S6-003/S7-002 | GoMock, property/race and Mongo Testcontainers opt-in/revoke/retention/privacy proofs pending | Recording defaults off; host proposes a bounded purpose/retention policy, every current participant explicitly opts in before start, joiners pause recording until consent, any revoke stops immediately |
| S7-006 | E10-S01 Oware domain rules and legality engine | 9 | `/root/backend_games` | IN PROGRESS | `services/api/internal/games/oware/` (domain + legality only; persistence is E10-S02) | claimed 2026-07-26; fully independent of active lanes | seed-conservation + grand-slam property tests pending | — |
