...
| S4-005 | S2-016 follow-up: wire privacy processor into worker with cross-context export/erasure | 4 | `/root/backend_privacy` | IN PROGRESS | `services/worker/internal/jobs/`, `services/api/internal/privacy/` | claimed 2026-07-26; dependencies S2-016 + S1-009 complete | export archive assembled + erasure executes via worker job, integration pending | — |
