...
| S0-005 | Monorepo and application/service skeletons | 0 | `/root/platform_scaffold` | IN PROGRESS | root manifests, `apps/`, `services/`, `packages/` | claimed 2026-07-26 | clean bootstrap/check/build | UI remains intentionally skeletal for S0-008 |
