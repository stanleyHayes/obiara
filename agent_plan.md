...
| S5-012 | E07-S11 Themes 2–4 progression kernel | 5 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/courtship/themeprogression/` bounded context | claimed 2026-07-26 after S5-008 | GoMock, race/property and Mongo Testcontainers order/conceal/reveal/privacy proofs pending | Fixed versioned themes unlock strictly in order only after both-member reveal; no skipping, purchase, score, popularity or public surface |
| S5-013 | E07-S11 client Themes 2–4 guided arc | 3 | `codex-root` | IN PROGRESS | web/Expo private-room theme progression presentation | claimed 2026-07-26 after S5-002/S5-008 | model/UI tests; web/mobile typecheck/lint/build; desktop/mobile accessibility QA pending | Calm locked/ready/revealed states and simultaneous-reveal language; no urgency, gamified progress, streak or paywall |
| S6-001 | E08-S01 Deterministic cloth grammar and render seed | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/cloth/grammar/` bounded context | claimed 2026-07-26 after E07 Theme One | GoMock, property/race and Mongo Testcontainers determinism/privacy proofs pending | Versioned canonical inputs produce the same bounded render seed everywhere; no raw private content, arbitrary code, randomness drift or user-supplied executable grammar |
| S6-002 | E08-S02 P0 first-thread and Theme One band | 5 | `/root/courtship_closure` | IN PROGRESS | isolated `services/api/internal/cloth/thread/` bounded context | claimed 2026-07-26 after S5-008 | GoMock, property/race and Mongo Testcontainers one-time issuance/privacy proofs pending | Pair-owned first thread is issued once from durable Theme One reveal evidence; immutable band provenance, opaque refs, no public relationship signal or purchasable bypass |
