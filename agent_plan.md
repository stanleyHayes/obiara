...
| S8-009 | E13-S03 Push, in-app and SMS routing with fallback | 10 | `/root/backend_notifications` | IN PROGRESS | `internal/notifications/routing/`, `internal/notifications/inapp/` | claimed 2026-07-26; unifies E13-S01 decisions with E13-S05 channel | routing/fallback unit + integration pending | — |
| S8-009 | E11-S08 liveness adapter and human uncertainty route | 5 | `codex-root` + `/root/consent_kernel` | DONE | existing provider-neutral `services/api/internal/verification/liveness/` plus client onboarding uncertainty state | audited 2026-07-26 against commit `8d3aadb` and S2-018; liveness race/full Go/vet, simulator contract, retry/replay/manual-review proofs; onboarding reducer/web quality evidence | Exact live is sole automatic pass; outage/uncertain outcomes queue bounded human review; explicit liveness consent required; temporary voice/face references leave client state and manual-review UI never silently approves | Existing implementation already satisfies E11-S08, so no duplicate adapter added; Mongo persistence remains a separately tracked durable-composition follow-up |
...
| S8-011 | E11-S09 Sow pre-delivery multilingual screening | 8 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/seed/screening/` policy/application adapter composed behind existing sow Screening port; no delivery/persistence ownership | claimed 2026-07-26 after S8-001 and existing E06-S04 pre-acceptance screening boundary | GoMock, multilingual/property/fuzz/race and persistence applicability proofs pending | Screen normalized bounded text/media metadata before acceptance across reviewed locale allowlist; uncertain/unsupported/error fails closed to human route; no raw retention, translation-as-truth, language exclusion, delivery-before-screen or allowance spend on rejection |
| S8-012 | E11-S10 Sika Shield text/voice patterns and precision gate | 8 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/safety/sikashield/` offline detector/evaluation boundary; no automatic member action or payment access | claimed 2026-07-26 after S8-001/S05 evaluation gates; matching evaluation lane released | GoMock, text/voice-metadata/property/fuzz/race and persistence applicability proofs pending | Bounded reviewed pattern versions, consented voice-derived metadata only, precision-first offline gate and human case route; no raw voice retention, accusation, auto-block, payment decision, sensitive inference, hidden score or unreviewed production activation |
| S8-013 | E12-S03 admin privacy-redacted evidence viewer and legal-hold workflow | 5 | `codex-root` | IN PROGRESS | new `apps/admin/app/safety/` MUI route with pure reducer fixtures; no backend mutation or raw evidence | claimed 2026-07-26 after E12-S01/S02 and existing verification desk patterns | reducer/privacy/legal-hold tests plus admin typecheck/lint/build and rendered browser proofs pending | Least-exposure case selection, bounded-purpose evidence open, redaction markers, audit acknowledgement and explicit reversible legal-hold request; no reporter identity, raw content, unlogged access, silent hold, automatic case action or destructive release |
