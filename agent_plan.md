...
| S8-026 | E12-S10 admin moderation workforce safeguards | 5 | `codex-root` | IN PROGRESS | new `apps/admin/app/workforce/` MUI route with pure reducer fixtures; no HR record, scheduling provider or evidence access | claimed 2026-07-26 after S8-013/S24 admin desk foundations | reducer/exposure/break/opt-out/escalation tests plus admin typecheck/lint/build and rendered browser proofs pending | Bounded shift/exposure counters, protected break, content-category preview, no-penalty opt-out and supervisor support request; no productivity score, forced viewing, diagnosis, hidden surveillance, retaliation flag or automatic work assignment |
