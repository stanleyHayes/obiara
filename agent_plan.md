...
| S5-003 | E07-S02 Strict drum alternation and voice-first stage opening | 5 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/courtship/drum/` bounded context | claimed 2026-07-26 after S5-001 | GoMock, race/property and Mongo Testcontainers alternation/replay/privacy proofs pending | Server-only turn authority; voice-first stage; no same-actor double turn, text-only bypass or public activity |
| S5-004 | E07-S03 Offline queue, retry and multi-device idempotency | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/courtship/queue/` bounded context | claimed 2026-07-26 after S5-001 | GoMock, race/property and Mongo Testcontainers replay/device-conflict proofs pending | Opaque idempotent commands; ordered per-room delivery; deterministic stale-device result; no duplicate event |
| S5-005 | E07-S04 Response windows, resting, re-light and archival | 5 | `/root/mobile_gestures` | IN PROGRESS | isolated `services/api/internal/courtship/pace/` bounded context | claimed 2026-07-26 after S5-001 | GoMock, race/property and Mongo Testcontainers time-boundary proofs pending | Calm response windows, mutual re-light, deterministic archive; no urgency/streak/read receipt |
| S5-006 | E07-S05 Pause Stone room suspension and safe resume | 3 | `codex-root` | IN PROGRESS | isolated `services/api/internal/courtship/pause/` bounded context | claimed 2026-07-26 after S5-001 | GoMock, race/property and Mongo Testcontainers suspension/replay/privacy proofs pending | Either member pauses immediately; sends fail closed; resume requires explicit mutual acknowledgement; safety/closure never blocked |
