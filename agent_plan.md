...
| S8-030 | E15-S01+S02 producer-enforced analytics schema registry and consent-aware pipeline | 10 | `/root/backend_analytics` | IN PROGRESS | `services/api/internal/analytics/` | claimed 2026-07-26; no analytics paths owned by active tasks | registry + no-content lint tests + integration pending | — |
