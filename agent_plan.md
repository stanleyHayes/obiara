...
| S5-008 | E07-S07 Guided theme one and simultaneous reveal | 5 | `/root/client_quality` | IN PROGRESS | isolated `services/api/internal/courtship/theme/` bounded context | claimed 2026-07-26 after S5-001–S5-007 | GoMock, race/property and Mongo Testcontainers conceal/reveal/privacy proofs pending | One fixed guided prompt; each member submits once; content remains concealed until both submit; simultaneous immutable reveal with no popularity or public surface |
| S5-009 | E07-S08 Call, meeting and exclusivity proposal objects | 5 | `/root/consent_kernel` | IN PROGRESS | isolated `services/api/internal/courtship/proposal/` bounded context | claimed 2026-07-26 after S5-001–S5-007 | GoMock, race/property and Mongo Testcontainers mutual-decision/replay/privacy proofs pending | Typed, expiring private proposals require explicit recipient acceptance; rejection/withdrawal is neutral; no phone number, unilateral status or public relationship signal |
| S5-010 | E07-S09 Kind closure and ghost-pattern behavior | 5 | `/root/courtship_closure` | IN PROGRESS | isolated `services/api/internal/courtship/closure/` bounded context | reassigned 2026-07-26 after `/root/mobile_gestures` declined without changes | GoMock, race/property and Mongo Testcontainers closure/timeout/privacy proofs pending | Either member may close immediately with a neutral private event; server-time inactivity may close without blame; no reason disclosure, accusation, score or public signal |
| S5-011 | E07-S10 Safety sheet, block/report and watermark | 5 | `codex-root` | IN PROGRESS | web/Expo private-room safety sheet and isolated safety contract | claimed 2026-07-26 after S5-002/S5-006 | model/UI tests; web/mobile typecheck/lint/build; desktop/mobile browser QA; server contract verification pending | Safety remains available in every room state; block is immediate, report requires a bounded category and evidence reference, captures are visibly watermarked; no public accusation or reason disclosure |
