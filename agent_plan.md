...
| S7-013 | E10-S04 conduct-only suban integration | 5 | `/root/courtship_closure` | IN PROGRESS | isolated `services/api/internal/games/conduct/` bounded context; no rating/matching coupling | claimed 2026-07-26 after S7-006; independent of active Oware session/rating lanes | GoMock, bounded-conduct/property/race and live MongoDB Testcontainers proofs pending | Suban records only conduct signals from bounded game events; never skill, win/loss, rating, popularity or matching visibility; appeals and provenance remain explicit |
| S7-014 | E10 client Oware room and async move experience | 5 | `codex-root` | IN PROGRESS | guarded web/Expo Oware room route, accessible board, turn/timer/notation and private room mount | claimed 2026-07-26 after S7-006 alongside server S7-011 | model/UI tests; web/mobile typecheck/lint/build; rendered accessibility/interaction/overflow QA pending | Deliberate legal move selection, calm async timer and notation; no leaderboard, matching advantage, popularity pressure, phone/contact/public-attendance exposure or invented server result |
